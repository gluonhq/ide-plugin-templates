...
@ParticleView(name = "${secondaryCSSName}")
public class ${secondaryViewName}View implements View {
    ...
    public void init() {
        ...
        button.setOnAction(e -> viewManager.switchView("${primaryCSSName}"));
    ...
    private void goHome() {
        viewManager.switchView("${primaryCSSName}");
    }
}
