...
<View fx:id="${primaryCSSName}" maxHeight="-Infinity" maxWidth="-Infinity" minHeight="-Infinity" minWidth="-Infinity" prefHeight="600.0" prefWidth="350.0"<#if afterburnerEnabled><#elseif cssPrimaryViewEnabled> stylesheets="@${primaryCSSName}.css"</#if> xmlns="http://javafx.com/javafx/8" xmlns:fx="http://javafx.com/fxml/1" fx:controller="${packageName}.views.${primaryViewName}Presenter">
   <center>
